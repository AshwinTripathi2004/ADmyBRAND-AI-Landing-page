...
export function TestimonialCard({ name, role, company, image, rating, content, isActive }: TestimonialCardProps) {
  return (
    <motion.div
      ...
      <Card className="glass p-8 lg:p-12 text-center border-0 bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl shadow-2xl">
        ...
        >
          ...
          <div className="text-left">
            ...
            <div className="text-blue-600 dark:text-blue-400 font-semibold text-sm">{company}</div>
          </div>
        </motion.div>
      </Card>
    </motion.div>
