...
const plans = [
  ...
  },
  {
    ...
    description: "Ideal for growing businesses and agencies scaling their marketing efforts",
    features: [
...
export function Pricing() {
  ...
  return (
    <section id="pricing" ref={ref} className="py-16 sm:py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <ScrollAnimationWrapper className="text-center mb-20" delay={0.2}>
          ...
          >
            <span className="text-gray-900 dark:text-white block mb-2">Simple, Transparent</span>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-20 items-stretch">
          {plans.map((plan, index) => (
            <ScrollAnimationWrapper
              ...
              className="h-full"
            >
              <PricingCard {...plan} isYearly={isYearly} index={index} />
            </ScrollAnimationWrapper>
          ))}
        </div>
