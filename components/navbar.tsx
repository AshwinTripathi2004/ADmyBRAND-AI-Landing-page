      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          >
            ...
            >
              <Zap className="h-4 sm:h-6 w-4 sm:w-6 text-white" />
            </motion.div>
            <span className="text-lg sm:text-xl font-bold gradient-text whitespace-nowrap">ADmyBRAND AI</span>
          </motion.button>
          ...
          <div className="hidden md:flex items-center space-x-2 lg:space-x-4">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button variant="ghost" className="font-medium text-sm lg:text-base whitespace-nowrap">
                Sign In
              </Button>
            </motion.div>
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 shadow-lg hover:shadow-blue-500/25 transition-all duration-300 text-sm lg:text-base whitespace-nowrap">
                Get Started
              </Button>
            </motion.div>
          </div>
            ...
            >
              <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
                ...
                <div className="flex flex-col space-y-3 pt-4 border-t border-gray-200/50 dark:border-gray-700/50">
                  <Button variant="ghost" className="justify-start text-base py-3">
                    Sign In
                  </Button>
                  <Button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 shadow-lg text-base py-3">
                    Get Started
                  </Button>
                </div>
              </div>
